/*
This algorithm counts castles by repeatedly cutting the rectangle in half vertically.
Its runtime is supposed to be O(w^2 log h), so it should be fast for tall, narrow rectangles.
*/
...
export const pathsFromCorner = ((width: bigint, height: bigint, endCorner: "up" | "down", stepType: "up" | "down", parity: Parity, modulo: bigint): bigint => {
	...
	- The path ends at (`width`, 0) if `endCorner` is "down", or at (`width`, `height`) if `endCorner` is "up".
