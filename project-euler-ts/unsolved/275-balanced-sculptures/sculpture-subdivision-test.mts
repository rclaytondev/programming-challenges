...
import { allSculptures, balancedSculptures, Component, Range, Sculpture, SculpturesCounter, symmetricalSculptures } from "./sculpture-subdivision.mjs";
import { assert } from "chai";
import { GeneratedIterable } from "./GeneratedIterable.mjs";
import { HashSet } from "../../../utils-ts/modules/HashSet.mjs";
import { Vector } from "../../../utils-ts/modules/geometry/Vector.mjs";
import { PartialSculpture } from "./middle-out-sculptures.mjs";
...
describe("SculpturesCounter.memoizedSculptures", () => {
	...
	const originalSculptures = SculpturesCounter.sculptures;
